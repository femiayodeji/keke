...
export default class Rider{
    ...
    update(deltaTime){
        ...
        let leftInput = this.game.score >= 1 ? this.game.keys.ArrowLeft : 0;
        this.speed -= (this.speed - (this.game.keys.ArrowRight - leftInput)) * 0.01;
        
        if(this.game.score < 1 && this.speed < 0) {
            this.speed = 0;
        }
